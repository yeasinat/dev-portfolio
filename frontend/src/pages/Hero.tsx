...
const Hero = () => {
  ...
  console.log(devData, devDataLoading);
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-10 px-4 py-8 sm:h-screen md:flex-row md:px-8 lg:px-16 lg:py-16">
      ...
      <div className="mb-10 w-full space-y-6 text-center md:mb-0 md:w-1/2 md:max-w-2xl md:text-left mt-20">
        <h1 className="font-poppins text-text text-4xl text-start leading-tight font-bold sm:text-5xl">
          <span className="text-accent text-start">
            <Typewriter
              options={{
        ...
        <p className="font-victor text-text/70 text-base sm:text-lg">
          ...
          code. I specialize in JavaScript technologies and frameworks.
        </p>
